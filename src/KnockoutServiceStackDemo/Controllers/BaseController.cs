...
{
  public abstract class BaseController : KnockoutServiceStackController //KnockoutController
  {
   ...
   string GetModel(string modelName)
    ...
    string GetController(string modelName)
    {
